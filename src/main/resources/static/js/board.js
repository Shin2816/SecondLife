...
//         const boardListBody = document.querySelector('#board-list-body');//갖고와서
//         boardListBody.innerHTML = ''; //초기화

//         data.forEach((element) => {//하나씩 뺏을 때 element
//             boardListBody.insertAdjacentHTML('beforeend', `
//                 <tr class='board-tr'onclick="location.href='/board/boardDetail?freeBoardNum=${element.freeBoardNum}'">
